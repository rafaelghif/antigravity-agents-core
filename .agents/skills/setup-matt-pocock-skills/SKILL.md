...
description: >-
  Configures the repository for engineering skills: sets up issue tracker configuration,
  triage label vocabulary, and domain documentation (CONTEXT.md / ADRs). Use when the user
  asks to initialize or set up engineering workflows, issue tracking, or domain doc layout.
---
