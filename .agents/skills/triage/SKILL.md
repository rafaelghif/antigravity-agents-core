...
name: triage
description: >-
  Triages incoming issues and pull requests through a state machine of triage roles,
  categorizing, verifying, and generating agent-ready briefs. Use when the user asks to
  triage issues, review incoming bugs, or organize the issue tracker.
---
...
4. **Grill (if needed).** If the request needs fleshing out, inspect "[grilling](../grilling/SKILL.md)" and "[domain-modeling](../domain-modeling/SKILL.md)" via `view_file`, and grill it into shape a round of questions at a time, sharpening domain terms and updating `CONTEXT.md`/ADRs inline as decisions land.
