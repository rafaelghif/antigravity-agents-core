...
name: retro
description: >-
  Conducts a retrospective on a coding session to identify improvements to the agent's environment, rules, and skills.
  Use when the user asks for a retrospective, session post-mortem, or suggestions to improve agent performance.
---
