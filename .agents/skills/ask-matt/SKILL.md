...
name: ask-matt
description: >-
  Acts as a router over the engineering and productivity skills to recommend which skill or workflow fits the user's situation.
  Use when the user asks which skill to use, what workflow to follow, or needs guidance navigating the available skills.
---
